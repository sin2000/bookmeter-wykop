...
$statu = new stats_utils(stats_utils::bm_edition_5);
...
<head>
  ...
  <link rel="stylesheet" href="stats.css?v=3" />
...
<body>
      ...
      <div class="col-auto align-middle pr-2 mb-1">
        <div class="btn-group dropright">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="../../podsumowanie/edycja5/index.php">Podsumowanie</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="../../tabela/index.php">Aktualna edycja</a>
        ...
        <a href="../../podsumowanie/edycja5/index.php" class="btn btn-outline-success ml-1" role="button">
            Podsumowanie
        </a>
      </div>
  ...
  <script src="stats.js?v=4"></script>
</body>
