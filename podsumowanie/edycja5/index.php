      ...
      <div class="col-auto align-middle pr-2 mb-1">
        <div class="btn-group dropright">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="../../tabela/edycja5/index.php">Tabela wpisów</a>
            <a class="dropdown-item" href="../../podsumowanie/edycja5/index.php"><b>Podsumowanie</b></a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="../../podsumowanie/index.php">Aktualna edycja</a>
            <div class="dropdown-divider"></div>
